...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini"  onload=”noBack();">
        <br>
        <div class="callout callout-success col-lg-6">
            <h4>Cadastro Realizado com Sucesso!</h4>

            <p>Seja bem vindo ao Bematech Software Partners!</p><br>
            <button class="btn btn-warning" onclick="window.location.href='http://bematechpartners.com.br/posgo/page-login.php';">Acessar o sistema posGo</button>
            <br><br>
            <span>
