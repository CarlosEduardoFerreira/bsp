...
function validaCadastro(evt) {
    var phone = document.getElementById('work_phone');
    ...
    /* Validação do campo work_phone */
    caixa_phone = document.querySelector('msg-phone');
    if (phone.value == "") {
//		alert('Preencha o telefone');                
        caixa_phone.innerHTML = "<i class='fa fa-times-circle-o'></i> Campo obrigatório!";
        caixa_phone.style.display = 'block';
        contErro += 1;
    } else {
        caixa_phone.style.display = 'none';
    }
