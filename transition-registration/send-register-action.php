...
$q = "INSERT INTO `client`(`name`, `last_name`, `cpf`, `office`, `email`, `password`, `id_company`, `phone`, "
        . "`cell`, `date_register`, `hour_register`, `profile`, `check_send_news`, `blocked`) SELECT `name`, "
        . "`last_name`, `cpf`, `office`, `email`, `password`, `id_company`, `phone`, `cell`, `date_register`, "
        . "`hour_register`, `profile`, `check_send_news`, `blocked` FROM client_temp WHERE cpf = '$cpf'";
$query = mysqli_query($conexao, $q);
if ($query) {
    $query2 = mysqli_query($conexao, "INSERT INTO `company`(`company`, `social_name`, `cnpj`, `cnae`, `work_phone`, "
