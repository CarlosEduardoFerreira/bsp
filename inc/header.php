    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="../AdminLTE/index2.html" class="logo">
                ...
                <span class="logo-lg"><b>Bematech</b>Partners</span>
            </a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        ...
                                        $res = mysqli_query($conexao, "SELECT date_register FROM client_bsp WHERE id_client = " . $_SESSION['id_client']);
                                        $result = mysqli_fetch_assoc($res);
                                        $data = $result['date_register'];
                                        ?>
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="../inc/logout.php" class="btn btn-default btn-flat">Sair</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
